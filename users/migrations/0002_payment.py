# Generated by Django 5.1.1 on 2024-09-18 01:46
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type_payment', models.CharField(choices=[('CASH', 'Оплата наличными'), ('CARD', 'Оплата картой')], max_length=50, verbose_name='способ оплаты')),
